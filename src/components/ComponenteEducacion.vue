...
.cd-timeline-img {
  ...
  height: 30px;
  border-radius: 50%;
  box-shadow: 0 0 0 4px rgb(8, 142, 126), inset 0 2px 0 rgba(0, 0, 0, 2), 0 3px 0 4px rgba(0, 0, 0, 1);
}
.cd-timeline-img {
  background: rgb(8, 142, 126);
}
@media only screen and (min-width: 1170px) {
  .cd-timeline-img {
    ...
    -webkit-transform: translateZ(0); /* Para compatibilidad con navegadores WebKit */
